function DecorativePill({text, white, italic, absolute, centered, margin}){
    ...
    return(
        <div className={`border border-${color} w-fit px-[1em] rounded-[20px] flex items-center ${margin ? "mt-[4em]": "mt-0"} ${absolute ? "absolute top-[100px] left-1/2 -translate-x-1/2": ""} whitespace-nowrap ${centered ? "mx-auto": ""}`}>
