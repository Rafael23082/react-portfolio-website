...
function Navbar({current}) {
  ...
  return (
    <div className="w-full flex bg-[#141414] navbar items-center py-[1em] relative">
      <p className="text-[1.2rem] lg:text-[1.4rem] text-white font-medium grow pl-[2em]" style={{fontFamily: "helvetica"}}>RAFAEL ANDERSON</p>
      ...
      <div className="hidden lg:flex grow-0 items-center text-white" style={{fontFamily: "figtree"}}>
        ...
        <button className="ml-[2em] bg-[#141414] border border-white text-white rounded-[1.25rem] self-center px-[1.5rem] py-[0.5rem] cursor-pointer hover:bg-[#84fc1c] hover:text-black hover:border-[#84fc1c] transition ease-in duration-200 mr-[2em]">Contact Me</button>
      </div>
